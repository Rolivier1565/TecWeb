...
class DBAccess{
  ...
  public function getPostList($maxidm){
    $query="SELECT Registrati.idr, Scrive.data, Scrive.ora, Messaggi.descrizione, Messaggi.argomento, Messaggi.mipiace, Messaggi.report, Messaggi.idm, Messaggi.report FROM Registrati, Scrive, Messaggi WHERE Registrati.idr=Scrive.idr AND Scrive.idm=Messaggi.idm AND Messaggi.idm<='$maxidm' ORDER BY Scrive.idm DESC LIMIT 7";
  ...
  public function addPost($usr, $ttl, $txt){
	...
	public function editPost($idPost, $testo){
